      ...
      <Col className="da-error-content da-py-32" span={24}>
        <Row className="da-h-100" align="middle" justify="center">
          <Col xxl={11} xl={15} lg={20} md={20} sm={24}>
            ...
            <br />
            <h3>Introduction</h3>
            Welcome to Netraga ("Company", "we", "our", "us"). These Terms of
            Service (“Terms”, “Terms of Service”) govern your use of our web
            services at https://www.netraga.com and the related subdomains
            including but not limited to https://app.netraga.com and
            https://api.netraga.com operated by Netraga Pvt. Ltd.
            <br />
            <br />
            ...
            netraga@gmail.com so we can try to find a solution. These Terms
            ...
            link or by dropping an email to info@netraga.com
            <br />
            <br />
            <h3>Purchases</h3>
            ...
            cancel it or Netraga (Netraga Pvt. Ltd.) cancels it. You may cancel
            your Subscription renewal either through your online account
            management page or by contacting Netraga (info@netraga.com) customer
            support team.
            <br />
            <br />A valid payment method, including credit card, is required to
            process the payment for your subscription. You shall provide Netraga
            ...
            automatically authorize Netraga to charge all Subscription fees
            incurred through your account to any such payment instruments.
            <br />
            <br />
            Should automatic billing fail to occur for any reason, Netraga shall
            ...
            <br />
            <h3>Fee changes</h3>
            Netraga, in its sole discretion and at any time, may modify
            ...
            <br />
            <br />
            Netraga will provide you with a reasonable prior notice of any
            ...
            to Netraga support team at info@netraga.com to request refunds.
            <br />
            <br />
            <h3>Restrictions</h3>
            You should comply with all applicable laws, including without
            limitation, privacy laws, intellectual property laws, anti-spam
            laws, equal opportunity laws and regulatory requirements. You shall
            never use Netraga for performing any illegal activities or
