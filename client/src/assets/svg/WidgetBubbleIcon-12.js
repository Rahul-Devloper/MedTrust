const WidgetBubbleIcon12 = (props) => (
  <svg
    width="100%"
    height="100%"
    viewBox="0 2 24 24"
  ...
  >
    ...
    ></path>
    <ellipse cx="8.5" cy="12" fill="#ffffff" rx="1.5" ry="2"></ellipse>
    <ellipse cx="15.5" cy="12" fill="#ffffff" rx="1.5" ry="2"></ellipse>
    <path fill="#ffffff" d="M8 16h8v2H8z"></path>
  </svg>
);
export default WidgetBubbleIcon12;
